...
def test_build_paper_deployment_service_wires_real_provider_clients_from_env(tmp_path, monkeypatch):
    ...
    service = build_paper_deployment_service(
        ...
        forced_square_off=lambda now: operational_calls.append("square_off"),
        interval_seconds=60,
    ...
    assert operational_calls == ["feed", "reconciliation", "square_off", "learning", "calibration"]
